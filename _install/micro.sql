...
INSERT INTO `posts` (`id`, `post_type`, `slug`, `title`, `content`, `status`, `is_deleted`, `created_on`, `updated_on`) VALUES
	...
	(3, 1, '404', '404', '&lt;section id=&quot;features&quot;&gt;\r\n	&lt;div class=&quot;container&quot;&gt;\r\n		&lt;div class=&quot;row&quot;&gt;\r\n			&lt;div class=&quot;center&quot;&gt;\r\n				&lt;div class=&quot;col-md-6 col-md-offset-3&quot;&gt;\r\n					&lt;h2&gt;Error 404&lt;/h2&gt;\r\n					&lt;hr&gt;\r\n					&lt;p class=&quot;lead&quot;&gt;The page you are looking for does not exist&lt;/p&gt;\r\n				&lt;/div&gt;\r\n			&lt;/div&gt;\r\n		&lt;/div&gt;\r\n	&lt;/div&gt;\r\n&lt;/section&gt;\r\n', 1, 0, '2017-07-06 16:10:40', '2017-07-14 16:59:08');
...
-- Dumping data for table micro.users: ~13 rows (approximately)
DELETE FROM `users`;
...
INSERT INTO `users` (`id`, `roles_id`, `username`, `password`, `fullname`, `email`, `mobile`, `address`, `about`, `status`, `is_deleted`, `created_on`, `udated_on`) VALUES
	(1, 2, 'admin', 'admin', 'Administrator', 'aa@aa.aa', '95666655888', 'asdasd', '', 0, 0, '2017-06-27 17:00:51', '2017-07-11 15:50:28'),
